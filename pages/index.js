  ...
  return (
    <div>
      ...
      <main className='font-poppins'>
        <div className="banner bg-[#43485D] w-full h-fit py-7 md:py-0 md:h-[500px] flex items-center justify-center relative">
          <div className="innerBanner bg-[#33384D] w-[90%] m-auto h-fit py-8 md:py-0 sm:h-[80%] md:h-[65%] lg:h-[75%] rounded-[10px] md:pl-[70px] md:flex md:justify-between">
            <div className="headerText flex items-center justify-center md:items-start flex-col md:space-y-6">
              ...
              <Link href="/hoodies">
                <button className=' bg-white py-2 px-3 md:py-[12px] md:px-[20px] lg:py-[14px] lg:px-[24px] rounded-[42px] font-medium flex items-start md:text-[20px] text-[#33384D] hover:bg-[#43485D] hover:text-white'>
                  SHOP NOW
