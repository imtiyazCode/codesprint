    ...
    return <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full md:w-3/4 mx-auto lg:h-auto object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51ZIqCyzpbL._UL1000_.jpg" />
