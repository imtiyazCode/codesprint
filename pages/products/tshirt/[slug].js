    ...
    return <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full px-3 sm:px-12 md:w-2/3 mx-auto lg:h-auto lg:px-0 object-cover object-top rounded" src="https://www.fajntricko.com/resize/e/1200/1200/files/2019-tricka/povolania/coding-pornstar/coding-pornstar-cerna.jpg/420x260" />
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div className="flex">
                        ...
                        <button className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-3 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add To Cart</button>
